 ...
 * - Vercel Blob: spara/ladda/synka + historik (se /api/profiles/*)
...
function buildPrescription(workoutId, workingRmKg, step) {
  ...
  switch (workoutId) {
    ...
    case 4: // Tung singel
      ...
      add("Back‑off", 5, 0.70);
      break;
    case 5: case 7: case 9: case 11: case 13: { // Failure Test – se till att rows[1] är block 2
      add("Block 1", 2, 0.87);
      add("Block 2", 5, 0.75);
...
export default function App() {
  ...
  // Se till att varje konto har blobKey
  useEffect(() => {
